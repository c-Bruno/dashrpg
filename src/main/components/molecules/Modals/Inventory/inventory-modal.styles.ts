import { Chip, Switch, Typography, styled } from '@mui/material';
...
export const WeaponToggleRow = styled('div')({
  display: 'flex',
  alignItems: 'center',
...
export const WeaponToggleLabel = styled(Typography)({
  fontSize: '0.78rem',
  color: GOLD,
  letterSpacing: '0.05em',
});

export const GoldSwitch = styled(Switch)({
...
export const CombatSection = styled('div')({
